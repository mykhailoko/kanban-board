...
📌 Kanban Board — интерактивная канбан-доска на React с поддержкой drag & drop, добавлением/редактированием задач и сохранением данных в localStorage.
...
![Kanban Board](src/assets/demo.png)
